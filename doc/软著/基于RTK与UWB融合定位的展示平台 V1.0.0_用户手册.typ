...
#figure(image("./assets/image.png"), caption: [主页])
#figure(
...
+ *电子围栏显示*：显示电子围栏
#figure(image("assets/image-2.png"), caption: [室外RTK地图])
...
+ *基站显示*：显示UWB定位基站位置
+ *电子围栏显示*：显示电子围栏
#figure(image("assets/image-3.png"), caption: [室内UWB地图])

== 设备管理
=== 设备状态监控
实时显示所有设备的在线状态、最后在线时间、当前位置等信息，支持按类型和标签过滤。
#figure(image("assets/image-18.png"), caption: [设备状态监控])
...
+ *设备删除*：移除不需要的设备记录
#figure(image("assets/image-4.png"), caption: [设备标记管理])
#grid(
  columns: (1fr, 1fr),
  gutter: 2em,
...
+ *标签管理*：管理设备标签，用于设备分类
  ...
  - *列出标签相同的设备*: #image("assets/image-21.png")
...
#figure(image("assets/image-20.png"),caption: [创建设备的类型])<创建设备的类型>
  - *列出标签相同的设备*: #image("assets/image-22.png")
...
=== 密码修改
提供密码修改功能，确保账户安全。#image("assets/image-23.png")
